...
const RegistrationForm = ({triggerPopup}) => {
    ...
    return (
        <Grid component="form" onSubmit={handleSubmit} container justifyContent="center">
            <Grid item xs={12} sm={10} md={8} lg={6}>
                <Card sx={{ mx: "auto", maxWidth: 600, mt: 5, p: 4, boxShadow: 4, borderRadius: 3 }}>
                    <CardContent>
                        ...
                        {/* Submit Button */}
                        <Button type="submit" fullWidth variant="contained" color="primary" sx={{ py: 1.5, fontSize: "1.1rem" }}>
                            Register Now
                        </Button>
                    </CardContent>
                </Card>
